export function Help() {
  return (
    <div id="help">
      <h3>Help</h3>
      Very simple score calculator for Balatro with many <b>limitations:</b> (non-exclusive list)
      <ul>
        <li>extra chips and mult must be summed manually, more or less</li>
        <li>retrigger cards must be accounted for manually</li>
      </ul>
      <hr/>
      ...
      <br />
      <b>Mult mult chain</b>: all of your multuplier multipliers. A list of numbers that will be multiplied
